...
function Register(props) {
  ...
  useEffect(()=>{
    if (isSubmit){
      axios.post('http://172.20.10.2:8080/user/register', postData)
      .then((res)=> {
        console.log(res);
        console.log("token is: "+res.data.data.apiKey)
  ...
  <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp" className="img-fluid" alt="Phone image"></img>
  </div>
      <Formik
        ...
        >
          <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1" style={{paddingTop:"6%"}}>
            <h1 id="heading-user">Register</h1>
            <Form>
              <div className='row'>
        ...
        {(!loggedIn && isSubmit)? <div className='loginError'>Already Exists</div>:<></>}
        </div>
